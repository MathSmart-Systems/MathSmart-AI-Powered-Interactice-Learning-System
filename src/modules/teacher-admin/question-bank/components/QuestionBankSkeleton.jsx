...
/**
 * The bank while its first read is still in flight.
 *
 * It reserves the shape the finished page occupies, block for block: the
 * intro note, the search row, the three filters, the state tabs, a full page
 * of rows and the footer. The previous version left out the tabs and the intro
 * entirely and drew three half-height rows against a page of ten, so the
 * content jumped several hundred pixels the moment the read resolved.
 */
