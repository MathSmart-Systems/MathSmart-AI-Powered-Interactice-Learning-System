/**
 * The transport behind assessment administration.
 *
 ...
 * Reading `message` off the top level instead is why every failure used to
 * arrive as a generic string, and why field-level feedback never reached a form.
 *
 * @param {unknown} body
 * @param {number} status
 */
