...
values (
  ...
  '{"id":"ee000000-0000-4000-8000-000000000003","competency_id":"ce000000-0000-4000-8000-000000000002","competency_name":"Harden competency two","text":"What is 2 + 2?","type":"number_input","choices":[]}'::jsonb,
  '4'::jsonb
);
